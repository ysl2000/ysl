...
class GCNModel(nn.Module):
    def __init__(self, vocab_size, embed_dim, hidden_dim, num_classes, num_gcn_layers=1, dropout=0.3):
        super().__init__()
...
def main():
    # 直接在代码中设置参数，无需命令行
    config = {
        'benign_dir': r'F:\OPGCN\benop',  # 良性样本目录
        'malicious_dir': r'F:\OPGCN\malop',  # 恶意样本目录
    ...
    print(f"唯一操作码数量: {len(all_opcodes)}")
